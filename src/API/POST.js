...
const LOGIN_URL = "https://registerpage.na4u.ru/api/login";
const REGISTER_URL = "https://registerpage.na4u.ru/api/register";
const COMPANY_ADD = "https://mycareercompany.na4u.ru/api/company/add";
