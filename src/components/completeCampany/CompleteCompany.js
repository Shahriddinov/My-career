...
function CompleteCompany(props) {
  ...
  const {
    ...
    CompanyGithub,
    CompanyTwitter,
    CompanyFirstNameHendler,
    CompanyLastNameHendler,
    CompanyEmailHendler,
    CompanyNumberHendler,
    CompanyImageHendler,
    CompanyCompanyHendler,
    CompanyCompanyNumHendler,
    CompanyLocationHendler,
    CompanyDescriptionHendler,
      ...
      <div className="wrapper">
        ...
        <div className="main-content">
          <div className="first-card1 card1" id="first-card">
            <p className="name-top-input">Welcome</p>
            ...
            <div className="all-r-l-input">
              <div className="right-input">
                <div>
                  ...
                  <input
                    onChange={(e) => CompanyFirstNameHendler(e.target.value)}
                ...
                <div>
                  ...
                  <input
                    onChange={(e) => CompanyEmailHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="e-mail"
                    placeholder="E-mail"
                  />
              ...
              <div className="left-input">
                <div>
                  ...
                  <input
                    onChange={(e) => CompanyLastNameHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="text"
                ...
                <div>
                  ...
                  <input
                    onChange={(e) => CompanyNumberHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="number"
          ...
          <div className="second-card1 card1" id="second-card">
            <p className="name-top-input">Your company!</p>
            ...
            <div>
              ...
              <input
                onChange={(e) => CompanyCompanyHendler(e.target.value)}
            ...
            <div>
              ...
              <input
                onChange={(e) => CompanyCompanyNumHendler(e.target.value)}
                placeholder="number"
                className="form-control inputs-all"
                type="text"
              />
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postCompany}>
                Next
              </button>
            </div>
          </div>
          <div className="third-card card1" id="third-card">
            <p className="write-about">About your company</p>
            <p className="complete-your">
            ...
            <div>
              ...
              <input
                onChange={(e) => CompanyLocationHendler(e.target.value)}
                type="text"
                className="form-control inputs-all"
              />
            </div>
            <div>
              ...
              <textarea
                onChange={(e) => CompanyDescriptionHendler(e.target.value)}
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postLocation}>
                Next
              </button>
            </div>
          </div>
          <div className="fourth-card card1" id="fourth-card">
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postContact}>
                Next
              </button>
            </div>
          </div>
