...
const PostJop3 = (props) => {
  ...
  return (
    <Jop>
      <div
        className="freelans1 bg-white position-absolute"
        style={{ zIndex: "10" }}
      >
        ...
        <form className="custom-form" onSubmit={formik.handleSubmit}>
          ...
          <div className="d-flex justify-content-end mt-3">
            <Link
              to={RoutesPath.postJop2}
              className="bg-dark rounded bg-opacity-10 text-black d-flex justify-content-center align-items-center p-2 px-3 me-3"
            >
              Back
            </Link>
            <Button
