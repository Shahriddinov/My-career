          ...
          >
            ...
            <a href="#" target="_blank">
              ...
              <span className="textBox">
                <span className="text">Доступно в</span>
                <br />
            ...
            <a href="#" target="_blank">
              ...
              <span className="textBox">
                <span className="text">Загрузите в</span>
                <br />
            ...
            >
              <div className="talent-info-box">
                ...
                <div className="talent-description">
                  ...
                  consectetur. Expedita quos nobis earum hic ex asperiores
                  quisquam sit!
                </div>
            ...
            >
              <div className="post-job-info-box">
                ...
                <div className="post-job">
                  <Button
                    onClick={() => {
                      navigate(RoutesPath.companyPostJob);
                    }}
      ...
      <div className="dotsBox">
        <div className="nav flex-column">
          <div
            ...
            className={
              margin === 0 ? "nav-link navtest active" : "nav-link navtest"
            }
          >
            <div className="dots" />
          </div>
          <div
            ...
            className={
              margin === -100 ? "nav-link navtest active " : "nav-link navtest"
            }
          >
            <div className="dots" />
          </div>
          <div
            ...
            className={
              margin === -200 ? "nav-link navtest active" : "nav-link navtest"
            }
          >
            <div className="dots" />
          </div>
          <div
            ...
            className={
              margin === -300 ? "nav-link navtest active" : "nav-link navtest"
            }
          >
            <div className="dots" />
          </div>
