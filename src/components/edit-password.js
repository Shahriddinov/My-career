...
const enhancer = connect(
  ({ addCompany: { initialValue } }) => ({ initialValue }),
  null
);
  ...
  return (
    <div className="edit-password-main-box" id="">
      <div className="forSteps">
        ...
        <div
          className={
            step1 ? "step-for-informationActive" : "step-for-information"
          }
        >
          <div
            className={step1 ? "ball-informationActive" : "ball-information"}
          >
            <div className="ball2-information">
              <div
                className={
                  information ? "titleForStepsActive" : "titleForSteps"
                }
              >
                Edit Profile
              </div>
        ...
        <div
          className={
            step2 ? "step-for-informationActive" : "step-for-information"
          }
        >
          <div
            className={step2 ? "ball-informationActive" : "ball-information"}
          >
            <div className="ball2-information">
              <div
                className={
                  yourCompany ? "titleForStepsActive" : "titleForSteps"
                }
              >
                Password
              </div>
        ...
        <div
          className={
            step3 ? "step-for-informationActive" : "step-for-information"
          }
        >
          <div
            className={step3 ? "ball-informationActive" : "ball-information"}
          >
            <div className="ball2-information">
              <div
                className={
                  success ? "titleForStepsActive done" : "titleForSteps done"
                }
              >
                Done
              </div>
      ...
      <div
        ...
        className="edit-password-main-box-two"
      >
            ...
            <div className="edit-password-page">
              <div className="for-x">
                <img
                  ...
                  src="./images/my-resume-prev.png"
                  alt=""
                />
              </div>
              <div className="textWelcome">Edit profile</div>
              ...
              <div className="boxForInput">
                ...
                <input
                  id={uuidv4()}
                  onChange={formikTwo.handleChange}
                  value={formikTwo.values.enterCode}
              ...
              <div className="boxForButtons">
                <div className="box-forgot-password"></div>
                <button
          ...
          {yourCompany ? (
            <div className="edit-password-page">
              <div className="mainBoxForCompany">
                <div>
                  <div className="textCompany">Edit Profile</div>
                  <div className="text-edit-profile">
                    Complete your profile to join our global community of
                    freelancers and start selling your services to our growing
              ...
              <div className="inputBoxCompany">
                ...
                <input
                  id={uuidv4()}
                  onChange={formikTwo.handleChange}
                  value={formikTwo.values.testNewPassword}
        ...
        <div className="right-box">
          {iconPerson ? (
            <img src="./images/person-for-add-company-page.png" alt="" />
          ) : (
