...
function CompleteForm({
  ...
  const {
    ...
    FreelancDataList,
    FreelancDataListJob,
    FreelancFirstNameHendler,
    FreelancFirstName,
    FreelancLastNameHendler,
    FreelancLastName,
    FreelancEmailHendler,
    FreelancEmail,
    FreelancPhoneHendler,
    FreelancPhone,
    ...
    FreelancStreet,
    FreelancPositionsHendler,
    FreelancPositions,
    FreelancDateOfBirthHendler,
    FreelancDateOfBirth,
    FreelancDescrobeHendler,
    FreelancDescrobe,
    FreelancWebsite,
  ...
  const addingRecSkills = (item) => {
    const its = datasSkills.filter((e) => {
      if (e.id == item.id) return e.name;
    });
      ...
      <div className="wrapper">
        ...
        <div className="main-content">
          <div className="first-card card1" id="first-card">
            <div onChange={baseImage} className="upload-image">
              {icon ? (
                <>
                  <img className="img-in-upload" src={user.image} alt="" />
                </>
              ) : (
                <>
            ...
            <div className="all-r-l-input">
              <div className="right-input">
                <div>
                  ...
                  <input
                    onChange={(e) => FreelancFirstNameHendler(e.target.value)}
                ...
                <div>
                  ...
                  <input
                    onChange={(e) => FreelancEmailHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="e-mail"
                    placeholder="E-mail"
                  />
              ...
              <div className="left-input">
                <div>
                  ...
                  <input
                    onChange={(e) => FreelancLastNameHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="text"
                ...
                <div>
                  ...
                  <input
                    onChange={(e) => FreelancPhoneHendler(e.target.value)}
                    className="form-control inputs-all"
                    type="text"
          ...
          <div className="second-card card1" id="second-card">
            <p className="name-top-input">Welcome {FreelancFirstName}</p>
              ...
              <div className="right-input">
                ...
                <select
                  onChange={(e) => {
                    ...
                    let dataRigions = countries.filter((v) => {
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postFrlAddress}>
                Next
              </button>
            </div>
          </div>
          <div className="third-card card1" id="third-card">
            <p className="write-about">Write a little about yourself</p>
            <div className="all-r-l-input">
              <div className="right-input">
              ...
              <div className="left-input">
                <div>
                  ...
                  <input
                    onChange={(e) => FreelancDateOfBirthHendler(e.target.value)}
                    type="date"
                    className="form-control inputs-all"
                  />
                </div>
                ...
                <div className="hob-input-box  form-control">
                  {hobs.map((hobs, index) => (
                    <div className="hob-item" key={index}>
                      ...
                      <span onClick={() => removeHop(index)} className="closeH">
                        x
                      </span>
                    </div>
                  ))}
                  <input
                    onKeyDown={handleKeyHop}
                    type="text"
            ...
            <div>
              <textarea
                onChange={(e) => FreelancDescrobeHendler(e.target.value)}
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postPositions}>
                Next
              </button>
            </div>
          </div>
          <div className="fourth-card card1" id="fourth-card">
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={postFrlLangs}>
                Next
              </button>
            </div>
          </div>
          <div className="fifth-card card1" id="fifth-card">
            ...
            <div className="all-btn-d-flex">
              ...
              <button className="btn btn-next-to" onClick={progressfifth}>
                Next
              </button>
            </div>
          </div>
          <div className="sixth-card card1" id="sixth-card">
            ...
            <div className="all-btn-d-flex">
              <button
                className="btn btn-next-to-bac"
                onClick={progresssixthback}
              >
                Back
              </button>
              <button className="btn btn-next-to" onClick={progresssixth}>
                Next
              </button>
            </div>
          </div>
          <div className="seventh-card card1" id="seventh-card">
            ...
            <div className="all-btn-d-flex">
              <button
                className="btn btn-next-to-bac"
                onClick={progressseventhback}
              >
                Back
              </button>
              <button className="btn btn-next-to" onClick={progressseventh}>
                Next
              </button>
            </div>
          </div>
          <div className="eighth-card card1 eight-card-resume" id="eighth-card">
            ...
            <p className="complete-your">
              Your resume is ready! You need to choose one of this templates and
              all your info will be filled in it already.
            </p>
            ...
            <div className="resume-content">
              <div className="resume-content__carusel" style={styles}>
                <div
                  className={
                    resumeActive === 1
                      ? "resume-card resume-card-1 resume-card--active"
                      : "resume-card resume-card-1"
                  }
                  onClick={() => ResumeActiveHendler(1)}
                >
                  <div className="resume-card-1__info">
                    <h2 className="resume-card-1__title">
                      {FreelancFirstName} {FreelancLastName}
                    </h2>
                    <p className="resume-card-1__info-jobtitle">
                      {FreelancPositions}
                    </p>
                    <div className="resume-card-1__personal-info">
                      ...
                      <div className="resume-card-1__info-column">
                        ...
                        <p className="resume-card-1__info-subtext">
                          {FreelancPhone}
                        </p>
                      </div>
                      <div className="resume-card-1__info-column">
                      ...
                      <div className="resume-card-1__info-column">
                        <p className="resume-card-1__info-text">
                          Work experience
                        </p>
                        {FreelancDataListJob.map((item, i) => {
                          return (
                            <p
                              ...
                              key={i + 1}
                            >
                              <span className="resume-card-1__info-subtext-company">
                                {item.company}
                              </span>{" "}
                              <span>
                  ...
                  <div className="resume-card-1__about">
                    <span className="resume-card-1__about-date">
                      {FreelancDateOfBirth}
                    </span>
                    <div className="resume-card-1__about-user">
                      <p className="resume-card-1__about-user-title">
                        {FreelancFirstName} {FreelancLastName}
                      </p>
                      <p className="resume-card-1__about-user-job">
                        {FreelancPositions}
                      </p>
                    </div>
                    ...
                    <p className="resume-card-1__about-text">
                      {FreelancDescrobe}
                    </p>
                  </div>
                </div>
                <div
                  className={
                    resumeActive === 2
                      ? "resume-card resume-card-2 resume-card--active"
                      : "resume-card resume-card-2"
                  }
                  onClick={() => ResumeActiveHendler(2)}
                >
                  <div className="resume-card-2__top">
                    <img
                      className="resume-card-2__top-user"
                      src={user.image}
                      alt="user"
                    />
                    <div className="resume-card-2__top-info">
                      ...
                      <div className="resume-card-2__top-infouser">
                        <div className="resume-card-2__top-infouserdf">
                          <div>
                            <span className="resume-card-2__top-infouser-title">
                              Phone:
                            </span>
                        ...
                        <div>
                          ...
                          <span>
                            {FreelancLivingAddress} {FreelancRegion}{" "}
                            {FreelancStreet}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="resume-card-2__main-about">
                      <div className="resume-card-2__main-aboutitem">
                        ...
                        <div>
                          {FreelancDataList.map((item, i) => {
                            return (
                              <div className="resume-card-2__main-aboutitem-edu">
                                <p>
                                  {item.start.substring(0, 4)} -{" "}
                                  {item.end.substring(0, 4)}
                                </p>
                    ...
                    <div className="resume-card-2__main-info">
                      ...
                      <div className="resume-card-2__main-infoitem">
                        ...
                        {FreelancDataListJob.map((item, i) => {
                          return (
                            <div
                              className="resume-card-2__main-infoitem-content"
                              key={i + 1}
                            >
                              ...
                              <div>
                                <span className="resume-card-2__subtext">
                                  {item.job}
                                </span>
                        ...
                        <div className="resume-card-2__main-infoitem-skills">
                          {tags.map((item, i) => {
                            return (
                              <div
                                key={i}
                                className="resume-card-2__main-infoitem-skill"
                              >
                                <p>{item}</p>
                ...
                <div
                  className={
                    resumeActive === 3
                      ? "resume-card resume-card-3 resume-card--active"
                      : "resume-card resume-card-3"
                  }
                  onClick={() => ResumeActiveHendler(3)}
                >
                  <div className="resume-card-3__about">
                    <img
                      className="resume-card-3__about-user"
                      src={user.image}
                      alt="user"
                    />
                    ...
                    <div className="resume-card-3__about-item">
                      ...
                      <span className="resume-card-3__about-item-span">
                        {FreelancPhone}
                      </span>
                    </div>
                    <div className="resume-card-3__about-item">
                  ...
                  <div className="resume-card-3__main">
                    ...
                    <div className="resume-card-3__main-item">
                      <p>about me</p>
                      <p className="resume-card-3__main-text">
                        {FreelancDescrobe}
                      </p>
                    </div>
                    <div className="resume-card-3__main-item">
                      ...
                      <div className="resume-card-3__main-item-center">
                        {FreelancDataListJob.map((item, i) => {
                          return (
                            <div
                              className="resume-card-3__main-itemdf"
                              key={i + 1}
                            >
                              <span className="resume-card-3__main-itemyears">
                                {item.start.substring(0, 4)} -{" "}
                                {item.end.substring(0, 4)}
                              </span>
                ...
                <div
                  className={
                    resumeActive === 4
                      ? "resume-card resume-card-4 resume-card--active"
                      : "resume-card resume-card-4"
                  }
                  onClick={() => ResumeActiveHendler(4)}
                >
                  <div className="resume-card-4__about">
                    <div className="resume-card-4__about-top">
                      <img
                        className="resume-card-4__about-user"
                        src={user.image}
                        alt="user"
                      />
                      <svg
                        className="resume-card-4__about-topsvg1"
                        width="262"
                        height="271"
                        viewBox="0 0 262 271"
                        fill="none"
                      ...
                      >
                        <g filter="url(#filter0_d_1537_5625)">
                          <path
                            d="M97.5601 -29.5158C104.656 -33.538 113.344 -33.538 120.44 -29.5159L167.725 -2.71468L214.578 24.8348C221.609 28.9693 225.953 36.4927 226.018 44.6493L226.45 99L226.018 153.351C225.953 161.507 221.609 169.031 214.578 173.165L167.725 200.715L120.44 227.516C113.344 231.538 104.656 231.538 97.5601 227.516L50.275 200.715L3.42196 173.165C-3.6095 169.031 -7.95312 161.507 -8.01796 153.351L-8.45 99L-8.01796 44.6493C-7.95312 36.4927 -3.6095 28.9693 3.42197 24.8348L50.275 -2.71468L97.5601 -29.5158Z"
                            fill="white"
                          />
                        </g>
                        <defs>
                          <filter
                            id="filter0_d_1537_5625"
                            x="-43.45"
                            y="-62.5325"
                            width="304.9"
                            height="333.065"
                          ...
                          >
                            ...
                            <feBlend
                              ...
                              result="effect1_dropShadow_1537_5625"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_dropShadow_1537_5625"
                              result="shape"
                            />
                          </filter>
                        </defs>
                      ...
                      <svg
                        className="resume-card-4__about-topsvg2"
                        width="305"
                        height="318"
                        viewBox="0 0 305 318"
                        fill="none"
                      ...
                      >
                        <g filter="url(#filter0_d_1537_5624)">
                          <path
                            d="M91.7415 -81.2179C102.447 -87.2858 115.553 -87.2858 126.258 -81.2179L191.65 -44.154L256.444 -6.05526C267.052 0.182121 273.605 11.532 273.703 23.8374L274.3 99L273.703 174.163C273.605 186.468 267.052 197.818 256.444 204.055L191.65 242.154L126.259 279.218C115.553 285.286 102.447 285.286 91.7415 279.218L26.35 242.154L-38.444 204.055C-49.0518 197.818 -55.6047 186.468 -55.7025 174.163L-56.3 99L-55.7025 23.8374C-55.6047 11.5321 -49.0518 0.182129 -38.444 -6.05524L26.35 -44.154L91.7415 -81.2179Z"
                            fill="#776CE2"
                          />
                        </g>
                        <defs>
                          <filter
                            id="filter0_d_1537_5624"
                            x="-86.3"
                            y="-111.769"
                            width="390.6"
                            height="429.538"
                          ...
                          >
                            ...
                            <feBlend
                              mode="normal"
                              in2="BackgroundImageFix"
                              result="effect1_dropShadow_1537_5624"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_dropShadow_1537_5624"
                              result="shape"
                            />
                          </filter>
                        </defs>
                    ...
                    <div className="resume-card-4__about-item">
                      <div className="resume-card-4__about-item-title">
                        ...
                        >
                          <path
                            d="M0 0H182C197.464 0 210 12.536 210 28V30H0V0Z"
                            fill="white"
                          />
                        </svg>
                        <p>education</p>
                      ...
                      {FreelancDataList.map((item, i) => {
                        return (
                          <>
                            <p className="resume-card-4__about-item-subtitle">
                              {item.school}
                            </p>
                            <p className="resume-card-4__about-item-subtext">
                              {item.start.substring(0, 4)}-
                              {item.end.substring(0, 4)}
                            </p>
                          </>
                    ...
                    <div className="resume-card-4__about-item">
                      ...
                      {tags.map((item, i) => {
                        return (
                          <p
                            className="resume-card-4__about-item-subtext"
                            key={i}
                          >
                            {item}
                          </p>
                  ...
                  <div className="resume-card-4__info">
                    <div className="resume-card-4__info-top">
                      <h2 className="resume-card-4__info-top-title">
                        {FreelancFirstName} <span>{FreelancLastName}</span>
                      </h2>
                      <p className="resume-card-4__info-top-jobtitle">
                        {FreelancPositions}
                      </p>
                      <svg
                        className="resume-card-4__info-topbg1"
                        width="156"
                        height="86"
                        viewBox="0 0 156 86"
                        fill="none"
                        ...
                        <defs>
                          ...
                          >
                            ...
                            <feBlend
                              mode="normal"
                              in2="BackgroundImageFix"
                              result="effect1_dropShadow_1537_5627"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_dropShadow_1537_5627"
                              result="shape"
                            />
                          </filter>
                        </defs>
                      ...
                      <svg
                        className="resume-card-4__info-topbg2"
                        width="85"
                        height="10"
                        viewBox="0 0 85 10"
                        fill="none"
                      ...
                      >
                        <path
                          d="M0 0H75C80.5229 0 85 4.47715 85 10H10C4.47715 10 0 5.52285 0 0Z"
                          fill="#776CE2"
                        />
                      </svg>
                      <svg
                        className="resume-card-4__info-topbg3"
                        width="91"
                        height="95"
                        viewBox="0 0 91 95"
                        fill="none"
                      ...
                      >
                        <g filter="url(#filter0_d_1537_5628)">
                          <path
                            d="M49.7192 24.0094C50.8238 23.3833 52.1762 23.3833 53.2808 24.0094L61.2875 28.5476L69.221 33.2124C70.3156 33.856 70.9918 35.0272 71.0018 36.297L71.075 45.5L71.0018 54.703C70.9918 55.9728 70.3156 57.144 69.221 57.7876L61.2875 62.4524L53.2808 66.9906C52.1762 67.6167 50.8238 67.6167 49.7192 66.9906L41.7125 62.4524L33.779 57.7876C32.6844 57.144 32.0083 55.9728 31.9982 54.703L31.925 45.5L31.9982 36.2969C32.0083 35.0272 32.6844 33.856 33.779 33.2124L41.7125 28.5476L49.7192 24.0094Z"
                            fill="#F6B399"
                          />
                        </g>
                        <defs>
                          <filter
                            id="filter0_d_1537_5628"
                            x="0.925049"
                            y="0.539795"
                            width="89.1499"
                            height="93.9204"
                          ...
                          >
                            ...
                            <feBlend
                              mode="normal"
                              in2="BackgroundImageFix"
                              result="effect1_dropShadow_1537_5628"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_dropShadow_1537_5628"
                              result="shape"
                            />
                          </filter>
                        </defs>
                    ...
                    <div className="resume-card-4__info-item">
                      ...
                      <p className="resume-card-4__info-item-text">
                        {FreelancDescrobe}
                      </p>
                    </div>
                    <div className="resume-card-4__info-item">
                      <div className="resume-card-4__info-item-subtitle">
                        ...
                        >
                          <path
                            d="M0 0H227C242.464 0 255 12.536 255 28V30H0V0Z"
                            fill="#776CE2"
                          />
                        </svg>
                        <p>work</p>
                          ...
                          <div className="resume-card-4__info-item-body">
                            <div className="resume-card-4__info-item-bodycontent">
                              <div className="resume-card-4__info-item-bodyl">
                                ...
                                >
                                  <path
                                    d="M5.9896 0.302937C6.30424 0.116188 6.69576 0.116188 7.0104 0.302938L9.725 1.91414L12.4776 3.45945C12.7967 3.63856 12.9924 3.97762 12.988 4.34349L12.95 7.5L12.988 10.6565C12.9924 11.0224 12.7967 11.3614 12.4776 11.5406L9.725 13.0859L7.0104 14.6971C6.69576 14.8838 6.30424 14.8838 5.9896 14.6971L3.275 13.0859L0.522361 11.5406C0.203309 11.3614 0.0075525 11.0224 0.0119615 10.6565L0.0500002 7.5L0.0119615 4.34349C0.0075525 3.97762 0.203309 3.63856 0.522361 3.45945L3.275 1.91414L5.9896 0.302937Z"
                                    fill="#776CE2"
                                  />
                                </svg>
                                <svg
                                  className="resume-card-4__info-item-body-svg2"
                                  width="1"
                                  height="55"
                                  viewBox="0 0 1 55"
                                  fill="none"
                              ...
                              <div className="resume-card-4__info-item-bodyr">
                                <div className="resume-card-4__info-item-bodyr-between">
                                  <p className="resume-card-4__info-item-bodyr-text1">
                                    {item.job}
                                  </p>
                                  <p className="resume-card-4__info-item-bodyr-text2">
                                    {item.start.substring(0, 4)}-
                                    {item.end.substring(0, 4)}
                                  </p>
                                </div>
                                <h4 className="resume-card-4__info-item-bodyr-title">
                                  {item.company}
                                </h4>
                                <p className="resume-card-4__info-item-bodyr-subtext">
                                  {item.tagName}
                                </p>
                              </div>
                            </div>
                ...
                <div
                  className={
                    resumeActive === 5
                      ? "resume-card resume-card-5 resume-card--active"
                      : "resume-card resume-card-5"
                  }
                  onClick={() => ResumeActiveHendler(5)}
                >
                  <div className="resume-card-5__top">
                    <div className="resume-card-5__top-info">
                      <h2>
                        <span className="resume-card-5__top-infoname">
                          {FreelancFirstName}
                        </span>{" "}
                        {FreelancLastName}
                      </h2>
                  ...
                  <div className="resume-card-5__main">
                    <div className="resume-card-5__main-info">
                      <div className="resume-card-5__main-item">
                        <p className="resume-card-5__main-item-text">
                          EDUCATION
                        </p>
                        {FreelancDataList.map((item, i) => {
                          return (
                            <div
                              className="resume-card-5__main-itemcenter"
                              key={i}
                            >
                              <p className="resume-card-5__main-item-subtext">
                                {item.start.substring(0, 4)}-
                                {item.end.substring(0, 4)}
                              </p>
                              <p className="resume-card-5__main-item-subtext">
                        ...
                        <div className="resume-card-5__main-itemcenter">
                          <div className="resume-card-5__main-item-lang">
                            {tags.map((item, i) => {
                              return (
                                <div
                                  className="resume-card-5__main-item-langcontent"
                                  key={i + 1}
                                >
                    ...
                    <div className="resume-card-5__main-about">
                      <div className="resume-card-5__main-item">
                        ...
                        <p className="resume-card-5__main-item-abouttext">
                          {FreelancDescrobe}
                        </p>
                      </div>
                      <div className="resume-card-5__main-item">
                        ...
                        <div className="resume-card-5__main-item-contactinfo">
                          <p>area</p>
                          <span>
                            {FreelancLivingAddress} {FreelancStreet}
                          </span>
                        </div>
                      </div>
                      <div className="resume-card-5__main-item">
                ...
                <div
                  className={
                    resumeActive === 6
                      ? "resume-card resume-card-6 resume-card--active"
                      : "resume-card resume-card-6"
                  }
                  onClick={() => ResumeActiveHendler(6)}
                >
                  <div className="resume-card-6__top">
                    <svg
                      className="resume-card-6__l-dotimg"
                      width="42"
                      height="42"
                      viewBox="0 0 42 42"
                      fill="none"
                    ...
                    <svg
                      className="resume-card-6__r-dotimg"
                      width="42"
                      height="42"
                      viewBox="0 0 42 42"
                      fill="none"
                    ...
                    >
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 40.5 1.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 27.5 1.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 14.5 1.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                      ...
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 40.5 14.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 40.5 27.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 40.5 40.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 27.5 14.5)"
                        fill="#323232"
                      />
                      <circle
                        r="1.5"
                      ...
                      <circle
                        r="1.5"
                        transform="matrix(-1 0 0 1 14.5 14.5)"
                        fill="#323232"
                      />
                    </svg>
                    <svg
                      className="resume-card-6__bg1"
                      width="194"
                      height="134"
                      viewBox="0 0 194 134"
                      fill="none"
                    ...
                    >
                      <path
                        d="M133.923 -75L164.336 -23.277L193.923 28.923L164.336 81.123L133.923 132.846L73.923 133.323L13.923 132.846L-16.49 81.123L-46.077 28.923L-16.49 -23.277L13.923 -75L73.9231 -75.477L133.923 -75Z"
                        fill="#C6D9DF"
                      />
                    </svg>
                    <svg
                      className="resume-card-6__bg2"
                      width="141"
                      height="123"
                      viewBox="0 0 141 123"
                      fill="none"
                    ...
                    >
                      <path
                        d="M105.622 1L123.363 31.1718L140.622 61.6218L123.363 92.0718L105.622 122.244L70.6218 122.522L35.6218 122.244L17.8808 92.0718L0.62178 61.6218L17.8808 31.1718L35.6218 1L70.6218 0.721777L105.622 1Z"
                        fill="#E3EBEE"
                      />
                    </svg>
                    <svg
                      className="resume-card-6__bg3"
                      width="214"
                      height="222"
                      viewBox="0 0 214 222"
                      fill="none"
                    ...
                    >
                      <path
                        d="M262.554 -82.5L306.907 -7.07056L350.054 69.0544L306.907 145.179L262.554 220.609L175.054 221.304L87.5544 220.609L43.2021 145.179L0.0544473 69.0544L43.2021 -7.07056L87.5544 -82.5L175.054 -83.1956L262.554 -82.5Z"
                        fill="#C6D9DF"
                      />
                    </svg>
                    <div className="resume-card-6__top-column">
                      ...
                      <div className="resume-card-6__top-contacts">
                        <div className="resume-card-6__top-contact">
                          <img
                            className="resume-card-6__top-contact-icon"
                            src={phone}
                            alt="phone"
                          />
                          <p>{FreelancPhone}</p>
                    ...
                    <img
                      className="resume-card-6__user-img"
                      src={user.image}
                      alt="user"
                    />
                  </div>
                  <div className="resume-card-6__main">
                    <div className="resume-card-6__main-info">
                      <div className="resume-card-6__main-item">
                        <p className="resume-card-6__main-item-title">
                          profile
                        </p>
                        <p className="resume-card-6__main-item-subtext">
                          {FreelancDescrobe}
                        </p>
                      </div>
                      <div className="resume-card-6__main-item">
                      ...
                      <div className="resume-card-6__main-item">
                        ...
                        {inputList.map((item, i) => {
                          return (
                            <div
                              className="resume-card-6__main-item-subtext resume-card-6__main-item-dots"
                              key={i}
                            >
                              <p className="resume-card-6__main-item-lang">
                                {item.language}
                              </p>
                              <div className="resume-card-6__main-item-contentdot">
                                <img
                                  className="resume-card-6__main-item-dot"
                                  src={resumedot}
                                  alt=""
                                />
                                <img
                            ...
                            <div key={i + 1}>
                              <div className="resume-card-6__main-item-top resume-card-6__main-item-top-jobcontent">
                                <div className="resume-card-6__main-item-content">
                                  <AiFillCaretRight className="resume-card-6__main-item-icon" />
                                  <p>
                                    {item.job} ({item.start.substring(0, 4)}-
                                    {item.end.substring(0, 4)})
                                  </p>
                                </div>
                              </div>
                              <p className="resume-card-6__main-item-job-text">
                                {item.company}
                              </p>
                              <p className="resume-card-6__main-item-subtext">
                                {item.tagName}
            ...
            <div className="resume-card__bottom">
              <div className="resume-controll">
                <button disabled={btnPrev} onClick={ResumeCaruselPrev}>
                  <img src={resumePrev} alt="prev" />
                </button>
                <div className="resume-controll__center">
                  <span
                    style={stylesCenter}
                    className="resume-controll__center--active"
                  ></span>
                </div>
                <button disabled={btnNext} onClick={ResumeCaruselNext}>
                  <img src={resumeNext} alt="next" />
                </button>
              </div>
              <div className="d-flex">
                <button
                  className="btn btn-next-to-bac"
                  onClick={progresseighthback}
                >
                  Back
                </button>

                <button
                  disabled={resumeActive === 0 ? true : false}
                  className="btn btn-next-to"
                >
                  <NavLink to={`/${RoutesPath.completeResume}`}>Next</NavLink>
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="container-circle-all">
          <div className="container">
            ...
            <p id="progress-text1" className="progress-text1 progress-text">
              Personal Information
            </p>
            <p id="progress-text2" className="progress-text2 progress-text">
              Address
            </p>
            <p id="progress-text3" className="progress-text3 progress-text">
              About Yourself and Skills
            </p>
            <p id="progress-text4" className="progress-text4 progress-text">
              Language
            </p>
            <p id="progress-text5" className="progress-text5 progress-text">
              Experience
            </p>
            <p id="progress-text6" className="progress-text6 progress-text">
              Educations
            </p>
            <p id="progress-text7" className="progress-text7 progress-text">
              Contacts
            </p>
            <p id="progress-text8" className="progress-text8 progress-text">
              Resume
            </p>
