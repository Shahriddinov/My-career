...
function ContractWiev(props) {
  const {contractPassport,contractCarta,contractInn,contractInps,contractBank,contractInnBank,contractTranzit,contractMfo} = useStore()
  return (
    <div className="contractWiev">
      ...
      <div className="contractWiev__employe">
        ...
        <p className="contractWiev__employe-subtext">The company offers services to improve the efficiency of other companies. With the help of our highly qualified specialists and modern technologies, we integrate our knowledge and skills to increase efficiency.
