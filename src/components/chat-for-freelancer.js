  ...
  return (
    <div className="chat-for-freelancer" id="">
      ...
      <div className="box-for-planshet">
        ...
        <div className="person-name">Shuxratov Azamat</div>
          ...
          <div className="box-top">
            <div className="company-name">
              ...
              <div className="name-company">
                Napa
                <div className="name-two">Automotive</div>
              </div>
            </div>
            <div className="about-company">
              <div className="tittle-company">About the company</div>
            ...
            <div className="link-company">
              <div className="link-title">Link company</div>
          ...
          <div className="box-bottom">
            <div className="phone-company">
              <div className="member-since">
                <div className="title-since">Member since</div>
                Aug 27, 2013
              </div>
...
export default ChatForFreelancer;
