        ...
        <div className="left">
          <div className="profilNameBox">
            ...
            <div className="profilName">
              <h2>
                Michel Rodriges <img src="/images/verification.svg" alt="" />
              </h2>
              <p>
            ...
            <Modal isOpen={modal1} toggle={toggle1}>
              ...
              <ModalFooter className="modal-footer">
                <div className="all-btn-d-flex">
                  <button
                    onClick={toggle1}
                    className="btn mx-2 btn-next-to-bac"
                  >
                    Cancel
                  </button>
                  <button onClick={toggle1} className="btn btn-next-to-bac">
                    Save
                  </button>
                </div>
              </ModalFooter>
          ...
          <button onClick={() => setVideo(!video)} className="addVideo">
          ...
          <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody>
              <div onChange={baseImage1} className="inputFile">
                {icon1 ? (
                  <>
                    <img className="portImg" src={portfolioImg} alt="" />
                  </>
                ) : (
                  <p>
              ...
              >
                {allTicher.map((item) => {
                  return (
                    <Option key={item.TICHERNAME}>{item.TICHERNAME}</Option>
                  );
                })}
              </Select>
            ...
            <ModalFooter className="modal-footer">
              <div className="all-btn-d-flex">
                <button onClick={toggle} className="btn mx-2 btn-next-to-bac">
                  Cancel
                </button>
                <button onClick={toggle} className="btn btn-next-to-bac">
                  Save
                </button>
              </div>
            </ModalFooter>
        ...
        <div className="rightee">
          ...
          <div className="Available">
            ...
            <p>
              ...
              <span className="gray">C2</span> - Native speaker
            </p>
            <p>
              {" "}
              <span className="bold">Russian:</span>{" "}
              <span className="gray">B2 </span> - Upper Intermediate
            </p>
            <hr />
          </div>
          <div className="Available">
            ...
            <p>
              {" "}
              <span className="bold">ID:</span> -Verified{" "}
          ...
          <div className="Available">
            ...
            <p>
              {" "}
              <span className="bold">NAPA Automotive: </span>
              UX UI Designer
              <br />
              <span className="gray">March 2022 - Now</span>
            </p>
            <hr />
          </div>
          <div className="Available">
