    ...
    <div className='client-card'>
      <div className='client-card__top'>
        <div className='client-card__top-info'>
          <h3 className='client-card__title client-card__subtitle'>Business Card Design</h3>
          <div className='client-card__top-sum'>
            <p>10$</p>
            <p>3 days</p>
          </div>
        </div>
        <p className='client-card__top-level'>Required level: <span>Middle</span></p>
      </div>
      <div className='client-card__description' onClick={() => setisTrueAccardion(!isTrueAccardion)}>
        <div className='client-card__text'>
          <p className='client-card__subtext'>Experienced designer required to make updates to website graphic assets,email banner. Files will be provided in Adobe illustrator,Photoshop PSD. Tasks as follows:</p><span className={isTrueAccardion === true ? 'client-card__text--active' : ''}>...</span><p className={isTrueAccardion === true ? 'client-card__text client-card__subtext ' : "client-card__text client-card__text--active"}> simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
        </div>
